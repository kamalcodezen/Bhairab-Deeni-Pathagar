  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">انداজে আপনার বর্তমানে ধার নেওয়া সকল বইয়ের তালিকা এবং মেয়াদ</p>
      </div>
                ...
                <div className="p-5 flex gap-4 bg-gray-50 dark:bg-dark-border/30 border-b border-gray-100 dark:border-dark-border">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <Link to={`/book/${borrow.bookId}`}>
                      <h3 className="font-bold text-gray-900 dark:text-white leading-tight mb-2 hover:text-primary-600 transition-colors text-ellipsis overflow-hidden whitespace-nowrap max-w-[150px]">
                        {borrow.bookTitle}
                      </h3>
                    </Link>
                    ...
                    <div className={`p-3 rounded-lg mb-5 text-sm flex items-start gap-2 ${
                      ...
                      {isOverdue ? (
                        <>
                          ...
                          <p>انداজে আপনার বইটি ফেরত দেওয়ার সময় শেষ হয়ে গেছে! অনুগ্রহ করে দ্রুত বইটি ফেরত দিন।</p>
                        </>
                      ) : (
                        <>
