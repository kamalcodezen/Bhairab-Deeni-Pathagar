...
import { 
  ...
  LogOut, Heart, BookMarked, LayoutDashboard, ShoppingCart 
} from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link to="/dashboard/wishlist" className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-border rounded-full transition-colors relative" title="পছন্দের তালিকা">
              ...
              <Link to="/cart" className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-border rounded-full transition-colors relative" title="বইয়ের ঝুড়ি (কার্ট)">
                <ShoppingCart size={20} className={cartCount > 0 ? "text-primary-600 dark:text-primary-400" : ""} />
                {cartCount > 0 && (
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-3">
              ...
              <Link to="/dashboard/wishlist" className="flex items-center justify-between px-3 py-2 rounded-md text-base font-medium text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-dark-border">
              ...
              <Link to="/cart" className="flex items-center justify-between px-3 py-2 rounded-md text-base font-medium text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-dark-border">
                <span className="flex items-center gap-2">
